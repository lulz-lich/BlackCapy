...
BlackCapy 1.0.3 is the current software baseline for the ESP32 firmware, microSD runtime tree, validation scripts, CI release gate and AI companion gateway.
